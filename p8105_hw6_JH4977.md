...
The cities are ordered by the adjusted odds ratio (OR) of a homicide
being solved for male victims relative to female victims. ORs below 1
indicate that cases with male victims are less likely to be solved than
those with female victims, after adjusting for victim age and race,
whereas ORs above 1 indicate the opposite.
